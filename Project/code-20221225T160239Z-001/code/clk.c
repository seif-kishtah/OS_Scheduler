...
//this process will only make a new shared memory with a certain key and increment it by 1 every second
...
int main(int argc, char *argv[])
{
    ...
    int *shmaddr = (int *)shmat(shmid, (void *)0, 0); //return address of the shared memory
    if ((long)shmaddr == -1)
    {
